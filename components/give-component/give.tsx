...
export default function Give() {
    return (
      ...
      <Image
        src="/SDGimg.png" // Replace with the actual path to your image
        alt="Hero background"
        layout="fill"
        objectFit="contain"
    ...
    <div className="relative mb-0 h-[50vh] md:h-[50vh] bg-dark bg-green-500 text-white">
      <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8">
        <h1 className="text-3xl sm:text-5xl md:text-2xl font-bold p-2 mb-40 leading-tight text-[#F9FAFB] font-aeonik">
        We Rise By Lifting Others. Support Us with Your Donations Every Contribution Counts, and We Promise Full Transparency.<br/>
        <br/>
        ACCOUNT INFORMATION
        </h1>
