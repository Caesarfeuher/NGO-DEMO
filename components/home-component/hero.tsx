  ...
  return (
    ...
    <section className="flex justify-between">
      ...
      {/* <section className="relative h-screen bg-gray-800 text-white">
        <div className="absolute inset-0 z-10 flex flex-col items-center justify-center text-center px-4 sm:px-6 lg:px-8 w-[100%]h- ">        
        <Image src="/SDGimg.png" alt="Hero background" layout="fill" objectFit="contain" objectPosition="center" className="z-0 opacity-20"/>
          </div> 
      </section> */}
       <section className="relative h-[100vh] sm:h-[50vh] bg-white text-white overflow-y-scroll bg-contain bg-center bg-no-repeat" style={{ backgroundImage: "linear-gradient(rgba(0, 0, 0, 0.2), rgba(0, 0, 0, 0.2)), url(/SDGimg.png)" }} ></section>
